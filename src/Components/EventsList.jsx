    ...
    return(
      ...
      <div className="flex  flex-col  sm:flex-row sm:justify-center rounded">
        {events.map((evento)=>(
             ...
             <div key={evento.id} className="w-[380px] h-[424px] mt-10 first:mt-0 bg-gray-900 sm:mt-0 sm:mr-10 last:mr-0 rounded mb-10  hover:scale-110 transition duration-200">  
